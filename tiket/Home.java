...
//        Memanggil Data Kelas
    ...
    private void initComponents() {
        ...
        stasiun_tujuan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bandung (BD)", "Gambir (GMR)", "Solo Balapan (SLO)", "Semarang Tawang (SMT)", "Banjar (BJR)" }));
        ...
        stasiun_awal.setText("Surabaya Gubeng (SGU)");
